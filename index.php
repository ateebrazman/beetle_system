            ...
            <div class="hero-sticky">
                ...
                <div class="curtain-top" id="curtain-top">
                    <div class="curtain-content">
                        <div class="split-text" data-text="BEETLE SYSTEM">BEETLE SYSTEM</div>
                    </div>
                </div>
                ...
                <div class="about-grid">
                    ...
                    <div class="about-image reveal-from-right">
                        <div class="img-reveal-wrapper">
                            <img src="<?php echo htmlspecialchars($about_image); ?>" alt="Office Space" loading="lazy">
                            ...
                            <div class="project-item">
                                <div class="project-img">
                                    <img src="<?php echo htmlspecialchars($hp['image_url'] ?: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2426'); ?>"
                                         alt="<?php echo htmlspecialchars($hp['title']); ?>" loading="lazy">
            ...
            <form id="multi-step-form">
                ...
                <div class="step active" data-step="1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ms-name" placeholder="Your Good Name" required>
                    </div>
                    <div class="form-group">
                        <label>COMPANY / ORGANIZATION</label>
                        <input type="text" id="ms-company" placeholder="Your Company Name" required>
                    </div>
                ...
                <div class="step" data-step="2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="ms-email" placeholder="Your Email Address" required>
                    </div>
                    <div class="form-group">
                        <label>PHONE NUMBER (OPTIONAL)</label>
                        <input type="tel" id="ms-phone" placeholder="Your Phone Number">
                    </div>
                    <div class="form-navigation">
