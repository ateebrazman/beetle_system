                ...
                <div class="story-layout">
                    <div class="story-image reveal-from-left">
                        <div class="img-reveal-wrapper">
                            <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=2301"
                                alt="Studio Architecture" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="story-content reveal-from-right">
                        <div class="about-body">
                            ...
                            <p>At Beetle System, we do more than just build websites. We create digital tools that help
                                your business grow. We believe that good design should be simple, and good code should
                                be powerful.</p>
                            <p>We started with a passion for clean design. Today, we help brands all over the world make
                                a great impression online with confidence.</p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="values-grid">
                    <div class="value-card reveal-from-bottom magnetic">
                        ...
                        <h3>Precision</h3>
                        <p>We sweat the small stuff. From pixel-perfect layouts to optimized server response times,
                            quality is non-negotiable.</p>
                    </div>
                    <div class="value-card reveal-from-bottom delay-1 magnetic">
                        <span class="value-num">02</span>
                        <h3>Innovation</h3>
                        <p>We stay at the bleeding edge of web technology, ensuring your project is built for the
                            future.</p>
                    </div>
                    <div class="value-card reveal-from-bottom delay-2 magnetic">
                        <span class="value-num">03</span>
                        <h3>Empathy</h3>
                        <p>We build for humans. Our user-centric design process ensures that your audience feels heard
                            and understood.</p>
                    </div>
                </div>
            </div>
