        ...
        <div class="login-container">
            ...
            <form class="login-form" method="POST" action="">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="text" name="admin_id" placeholder="AD-001-X" required style="background: rgba(0,0,0,0.02); border: 1px solid rgba(0,0,0,0.1); padding: 1rem; border-radius: 8px; width: 100%; font-family: var(--font-main);">
                </div>
                <div class="form-group" style="margin-bottom: 0;">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="integer" name="captcha" placeholder="Result" required style="background: rgba(0,0,0,0.02); border: 1px solid rgba(0,0,0,0.1); padding: 1rem; border-radius: 8px; width: 100%;">
                </div>
