...
<body class="admin-layout">
    ...
    <main class="admin-main">
        <div class="admin-header">
            ...
            <div class="admin-user-badge">
                ...
                <strong style="margin-left:5px;">Clients</strong>
            </div>
        </div>
        ...
        <div class="admin-stats-grid">
            <div class="admin-stat-card" style="box-shadow: 0 10px 40px rgba(0,0,0,0.03); border: 1px solid rgba(0,0,0,0.04);">
                ...
                <div style="color:#666; font-size:0.85rem; font-weight:600;">Total Clients</div>
            </div>
        </div>

        <div class="admin-card" style="box-shadow: 0 10px 40px rgba(0,0,0,0.03); border: 1px solid rgba(0,0,0,0.04);">
            <h3 style="margin-bottom: 2rem; font-family: var(--font-heading);"><i class="fas fa-address-book"></i> Client List</h3>
                ...
                <table style="width:100%; border-collapse: separate; border-spacing: 0 10px;">
                    ...
                    <tbody>
                            ...
                            <tr style="background: rgba(0,0,0,0.02); transition: transform 0.3s ease;">
                                ...
                                <td style="padding:1.2rem;">
                                    <div style="display:flex; flex-direction:column; gap:0.3rem;">
                                        ...
                                        <?php else: ?>
                                            <span style="color:#aaa; font-size:0.8rem; font-style:italic;">No phone number</span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td style="padding:1.2rem;">
                        ...
                        <?php if (empty($clients)): ?>
                            <tr><td colspan="6" style="padding:4rem; text-align:center; opacity:0.3; font-style:italic;">No clients found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
    ...
    <div id="clientModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:2000; backdrop-filter:blur(15px); align-items:center; justify-content:center;">
        <div class="admin-card" style="width:100%; max-width:600px; margin-bottom:0; background:#fff; padding:3rem;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2rem;">
                <h2 style="font-family: var(--font-heading); margin-bottom:0; letter-spacing:1px;">CLIENT INFORMATION</h2>
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:2rem; margin-bottom:2.5rem;">
                <div>
                    <label style="font-size:0.65rem; font-weight:900; opacity:0.4; display:block; margin-bottom:0.5rem; text-transform:uppercase; letter-spacing:1px;">Client Name</label>
                ...
                <div>
                    <label style="font-size:0.65rem; font-weight:900; opacity:0.4; display:block; margin-bottom:0.5rem; text-transform:uppercase; letter-spacing:1px;">Service</label>
    ...
    <div id="confirmModalClient" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:9000; backdrop-filter:blur(5px); align-items:center; justify-content:center;">
        <div style="background:var(--bg-primary); border:1px solid rgba(0,0,0,0.05); box-shadow:0 30px 60px rgba(0,0,0,0.15); border-radius:12px; max-width:400px; width:90%; text-align:center; padding:3rem;">
            ...
            <h3 style="font-family: var(--font-heading); margin-bottom:0.8rem; font-weight:800; color:#111; letter-spacing: 1px;">DELETE CLIENT</h3>
            <p style="font-size:0.95rem; color:#666; margin-bottom:2.5rem; line-height:1.5;">Are you sure you want to permanently delete this client? All linked data will be lost.</p>
            ...
            <form method="POST">
                ...
                <div style="display:flex; gap:1rem;">
                    ...
                    <button type="submit" style="flex:1; padding:0.8rem; font-weight:700; letter-spacing:1px; font-size:0.75rem; border-radius:6px; cursor:pointer; background:#ff3b30; color:#fff; border:none; transition: 0.3s;">DELETE CLIENT</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function viewClientTrace(client) {
            ...
            document.getElementById('viewClientPhone').innerText = client.phone || 'No phone number';
            ...
            document.getElementById('viewClientMessage').innerText = client.message || 'No message provided.';
